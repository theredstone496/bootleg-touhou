...
public class Wall3A : Attack
{
    GameObject[] walls;
    GameObject wallObj;
    bool bulletBlock;
    int wallCount;
    public Wall3A(GameObject enemy, GameObject player, GameObject wallObj, bool bulletBlock = true): base(null, player, enemy) {
        wallCount = 7;
    ...
    public override void ActivateAttack(int spellTime) {
        ...
        for (int i = 0; i < wallCount; i++) {
            if (walls[i] == null) {
                ...
                walls[i].transform.position = new Vector3(Random.Range(0f,12f),10,0);
